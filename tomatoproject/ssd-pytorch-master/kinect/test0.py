...
class Kinect(object):
    def __init__(self):
        ...
        self.w_color = 512#1920
        self.h_color = 424#1080
        self.w_depth = 206#512
        self.h_depth = 212#424
        """————————————————(2019/5/10)——————————————————"""
        self.csp_type = _ColorSpacePoint * np.int(192 * 108)
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        # a.Kinect_imshow("all")
        # print(color_data[2])
        # cv.namedWindow('image', 512 | 424)
        # cv.imshow('image',color_data[0])
        depthpoint = a.map_color_point_to_depth_point([100,100])
        print(depthpoint)
        result = depth2xyz(0,0,color_data[3][0][0])
        print(result)
        time.sleep(3)
        cv.waitKey(1)
