...
class SSD(object):
    _defaults = {
        ...
        # "model_path"        : 'logs/Epoch78-Total_Loss1.0947-Val_Loss1.0098.pth',#该行代码是预测圣女果时用的权重
        "model_path"        : 'logs/Epoch1173-Total_Loss1.2268-Val_Loss1.1563.pth',#该行代码是预测圣女果时用的权重
    ...
    def detect_image(self, image):
        ...
        for i, c in enumerate(top_label):
            ...
            print(label, top, left, bottom-top, right-left)
            information = [label, top, left, bottom-top, right-left]# label y,x(左上角) h w 
